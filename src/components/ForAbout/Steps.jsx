...
const Steps = () => {
  return (
    ...
    <div className='mt-20 mb-5 container text-center'>
     ...
     <div className='container md:flex gap-5 justify-between py-12 px-4 md:px-0 space-y-5 md:space-y-0'>
          <div className='bg-[url("/images/ForAbout/plan.jpg")] bg-cover bg-bottom text-center rounded-lg text-white group'>
               <div className='bg-black hover:bg-opacity-80 duration-300 bg-opacity-50 p-8 md:h-[45vh] lg:h-[65vh] flex flex-col justify-center rounded-lg'>
               ...
               <button className='border-b lg:w-[30%] pb-1 mx-auto flex items-center gap-2'>Read More <HiOutlineArrowUpRight /></button>
               </div>
          </div>
